...
import com.example.bcawhatsapp.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        auth=FirebaseAuth.getInstance();//database instance
        database=FirebaseDatabase.getInstance();//realtime database instance

        //setting up progress diolouge while sign up/in*********************************************
        progressDialog=new ProgressDialog(SignUpActivity.this);
        progressDialog.setTitle("Creating Account");
        progressDialog.setMessage("We're creating your account");
        //******************************************************************************************

        //setting up the data in the authentication page of firebase by mail & password*************
        binding.btnSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                progressDialog.show();//showing progress dialouge
        ...
        //if user have & account & want to sign in**************************************************
